        ...
        function (e, t, n) {
          !(function (e, i) {
                  ...
                  if (i && i.length && window.FileReader && window.File)
                    ...
                    try {
                      ...
                      if (d) {
                        ...
                        t.replaceSelection(d, 'around', 'linki'),
            ...
            function za (e, t, n, i, r) {
              ...
              var a = +new Date() - 200,
                l = 'linki' == r || e.state.linkiIncoming > a,
                s = Oe(t),
                u = null
              if (l && i.ranges.length > 1)
                if (Oa && Oa.text.join('\n') == t) {
                  ...
                  s.length == i.ranges.length &&
                    e.options.linkiLinesPerSelection &&
                    (u = Q(s, function (e) {
                      return [e]
                    }))
              for (
                ...
                var g = {
                  ...
                  origin:
                    r ||
                    (l ? 'linki' : e.state.cutIncoming > a ? 'cut' : '+input')
                }
              ...
              t && !l && Ra(e, t),
                ...
                (e.curOp.typing = !0),
                (e.state.linkiIncoming = e.state.cutIncoming = -1)
            }
            function Ha (e, t) {
            ...
            ;(Ka.prototype.init = function (e) {
              ...
              e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
                ...
                pe(r, 'linki', function (e) {
                  xe(i, e) ||
                    Ha(e, i) ||
                    ((i.state.linkiIncoming = +new Date()), n.fastPoll())
                }),
                pe(r, 'cut', o),
                pe(r, 'copy', o),
                pe(e.scroller, 'linki', function (t) {
                  if (!Sn(e, t) && !xe(i, t)) {
                    if (!r.dispatchEvent)
                      return (
                        (i.state.linkiIncoming = +new Date()), void n.focus()
                      )
                    var o = new Event('linki')
          ...
          function se (e) {
            ...
            if (
              ...
              this.codemirror.on('dragenter', function (e, t) {
                ...
                this.codemirror.on('linki', function (t, n) {
                  e.imageUploadFunction
                    ? a.uploadImagesUsingCustomFunction(
                        e.imageUploadFunction,
